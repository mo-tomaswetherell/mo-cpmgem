...
class NCSNv2(nn.Module):
    def __init__(self, config):
        ...
        self.res2 = nn.ModuleList(
            [
                ResidualBlock(
                    self.nf, 2 * self.nf, resample="down", act=act, normalization=self.norm
                ),
                ResidualBlock(
                    2 * self.nf, 2 * self.nf, resample=None, act=act, normalization=self.norm
                ),
            ]
        )
...
class NCSN(nn.Module):
    def __init__(self, config):
        ...
        self.refine1 = CondRefineBlock(
            [2 * self.nf], 2 * self.nf, config.model.num_scales, self.norm, act=act, start=True
        )
        self.refine2 = CondRefineBlock(
            [2 * self.nf, 2 * self.nf], 2 * self.nf, config.model.num_scales, self.norm, act=act
        )
        self.refine3 = CondRefineBlock(
            [2 * self.nf, 2 * self.nf], self.nf, config.model.num_scales, self.norm, act=act
        )
        self.refine4 = CondRefineBlock(
            [self.nf, self.nf], self.nf, config.model.num_scales, self.norm, act=act, end=True
        )
...
class NCSNv2_128(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.res3 = nn.ModuleList(
            [
                ResidualBlock(
                    2 * self.nf, 2 * self.nf, resample="down", act=act, normalization=self.norm
                ),
                ResidualBlock(
                    2 * self.nf, 2 * self.nf, resample=None, act=act, normalization=self.norm
                ),
